...
\begin{proof}[Beweis zu \ref{milnorfolge}]
  ...
  Tatsächlich kann man für ein fix gewähltes Primelement $\pi\in P_d$
  jedes Element $\ov\{f_1,\dotsc,f_n\}}\in L_d/L_{d-1}$ als Summe von
Elementen der Form 
  ...
  \begin{proof}
    ...
    welche 
    %verknüpft mit der Projektion auf $L_d/L_{d-1}$ 
    eine Umkehrabbildung
    % $h_\pi\colon \K_{n-1}(\Ftpi)\to L_d/L_0$ 
