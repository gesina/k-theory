...
\begin{Satz}[Existenz und Eindeutigkeit eines \enquote{Zahmes
    Symbol}-Homomorphismus]
Es gibt einen eindeutigen Homomorphismus 
$\partial_v\colon \KnF\to \K_{n-1}(\bF)$ (weiterhin als
$\partial$ abgekürzt), der für alle Primelemente $\pi\in R$ und 
