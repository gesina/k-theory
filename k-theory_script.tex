...
\begin{Satz}[Existenz und Eindeutigkeit eines \enquote{Zahmes
    Symbol}-Homomorphismus]\label{zahmessymbolhom}
  Zum diskret bewerteten Körper $(\F,v)$ gibt es für alle $n\geq 1$
...
\begin{proof}[Eindeutigkeit zu \ref{zahmessymbolhom}]
  ...
  $R=\pi U$. Diese muss nach \ref{bemzahmessymbolhom} surjektiv sein
