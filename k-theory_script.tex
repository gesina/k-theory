...
\begin{Bem}\label{darstellungdbk}
  ...
  \item Ein diskreter Bewertungsring ist nach \ref{bewertungsringhir}
    ...
    \begin{gather*}
      ...
      %\exists k\in\Z, u\in R^\times\colon\; 
      x=\pi^k\cdot u
      \qquad k\in\Z, u\in R^\times
    \end{gather*}
...
$x=\pi^k\cdot u$ mit einem $k\in\Z, u\in R^\times$,
...
\begin{Satz}\label{zahmessymbolhom}
  ...
  einen eindeutigen Ringhomomorphismus $\psi\colon\KF\to\KbF$, 
  der für alle Einheiten $u\in R^\times$, $k\in\Z$ erfüllt
  \begin{gather}\label{relationdualzahmessymbol}
    \psi(\{\pi^ku\})=\{\ov u\}
  \end{gather}
  $\partial$ heißt Zahmes Symbol oder Restklassenabbildung und $\psi$
  wird Spezialisierungsabbildung genannt.
\end{Satz}
...
\begin{Bem}\label{bemzahmessymbolhom}
  ...
  \item Das Zahme Symbol muss surjektiv sein, da für einen lokalen Ring
    ...
    $R/\frakm_v\cong R^\times$ gilt. Damit finden sich für alle 
    $v_1,\dotsc,v_n\in \bF^\times= R/\frakm_v\cong R^\times$
    eindeutige $u_1,\dotsc, u_n\in\R^\times\subset\Fx$, 
    so dass $\ov u_i=v_i$, 
  ...
  \item   Mit der Relation $u_1=\frac{\pi u_1}{\pi}$
    ...
    gilt für bel. $u_1,\dotsc, u_n\in R^\times, n\in\N$
    \begin{align*}
...
\begin{proof}[Eindeutigkeit zu \ref{zahmessymbolhom}]
  ...
  Einheiten $u\in R^\times$ und $\pi$ prim.
...
\begin{proof}[Existenz zu \ref{zahmessymbolhom}]
  ...
  ein Element $\{\pi^ku\}\in\KoF, u\in R^\times,$
  ...
  % Für $x=\{\pi^k u\}$, $y=\{\pi^l v\}$, $u,v\in R^\times$ gilt
  % \begin{align*}
...
%  Jetzt haben wir einen Ringhomomorphismus von $\KF$ nach $\KbF[\xi]$.
  ...
  von oben ist.
  Es ist also mit
  $\psi(\{a_1,\dotsc,a_n\})\coloneqq \{\ov u_1,\dotsc,\ov u_n\}$
  und $\partial(\{a_1,\dotsc,a_n\})\coloneqq \chi'$ wie oben
  \begin{gather*}
    \Psi(\alpha) = \psi(\alpha)\p \xi\partial(\alpha)
    \quad \forall\alpha\in\KnF
  \end{gather*}
  woraus schon folgt, 
  dass $\delta\colon\KnF\to\K_{n-1}(\bF)$ Gruppenhomomorphismus 
  und $\psi\colon\KnF\to\KnbF$ sogar Ringhomomorphismus ist.
  ...
  \begin{align*}
    ...
    &=\psi(\alpha) \p \xi\partial(\alpha)
  \end{align*}
  Daraus folgt bereits
  $\partial(\{\pi,u_1,\dotsc,u_n\})=\{\ov u_1,\dotsc,\ov u_n\}$.  
  Und $\psi$ erfüllt \ref{relationdualzahmessymbol}, denn 
  die Definition von oben liefert für $n=1$ und fix gewähltes
  Primelement $\pi$ zu $a=\pi^ku\in\Fx, u\in\R^\times$ genau
  $\psi(\{a\})=\psi(\{\pi^ku\})\coloneqq\ov \{u\}$.
...
%   $\psi\colon\KF\to\KbF$ der für alle Einheiten $u\in R^\times$, 
%   $k\in\Z$ erfüllt
%   \begin{gather*}
%     \psi(\{\pi^ku\})=\{\ov u\}
%   \end{gather*}
...
Bewertungsring zum Funktionenkörper $\F(t)$.
...
\begin{Satz}[Milnor]\label{milnorfolge}
  ...
  % \begin{center}
  %   \begin{tikzcd}
  %     0 \ar[r] & \KnF \ar[r] & \K_n(\F(t)) \ar[r] 
  %     & \bigoplus_{\pi\in P}K_{n-1}(\F[t]/(\pi)) \ar[r] & 0
  %   \end{tikzcd}
  % \end{center}
  \begin{gather*}
        0 \longrightarrow \KnF 
        \longrightarrow \K_n(\F(t))
        \longrightarrow \bigoplus_{\pi\in P}K_{n-1}(\F[t]/(\pi))
        \longrightarrow 0
  \end{gather*}
  Spaltend bedeutet, dass 
  $\K_n(\F(t))\cong\KnF\oplus\bigoplus_{\pi\in P}K_{n-1}(\F[t]/(\pi))$.
\end{Satz}

\begin{Bem}
  Für den Fall $n=1$ liefert \ref{milnorfolge}
  \begin{gather*}
    \F(t)^\times
    \cong \Fx
    \oplus\bigoplus_{\pi\in P}
      \K_{n-1}(\F[t]/(\pi))
    \end{gather*}
    ist die anschauliche Interpretation, dass es die Zerlegung eines
    Polynoms in seine irreduziblen Faktoren ist.
\end{Bem}
